    ...
    <form action="edit.php?id=<?php echo $cliente['id']; ?>" method="post">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-2">
          ...
          <input type="text" class="form-control" name="cliente['cep']" value="<?php echo $cliente['cep']; ?>" placeholder="Infrome o CEP">
        </div>

        <div class="form-group col-md-2">
          <label for="campo3">UF</label>
          <input type="text" class="form-control" name="cliente['uf']" value="<?php echo $cliente['uf']; ?>" placeholder="Infrome o UF">
        </div>
      ...
      <div class="row">
        <div class="form-group col-md-3">
          ...
          <input type="text" class="form-control" name="cliente['rua']" value="<?php echo $cliente['rua']; ?>" placeholder="Infrome a rua">
        </div>

        <div class="form-group col-md-2">
          <label for="campo2">Bairro</label>
          <input type="text" class="form-control" name="cliente['bairro']" value="<?php echo $cliente['bairro']; ?>" placeholder="Infrome o bairro">
        </div>
